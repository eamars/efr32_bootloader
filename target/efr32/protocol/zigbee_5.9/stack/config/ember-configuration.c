...
EmRouteTableEntry *emRouteData = (EmRouteTableEntry *) &emAvailableMemory[END_emChildTimers];
uint8_t emRouteTableSize = EMBER_ROUTE_TABLE_SIZE;
#define END_emRouteData        \
 (END_emChildTimers + align(EMBER_ROUTE_TABLE_SIZE * sizeof(EmRouteTableEntry)))
...
bool emberRtosIdleHandler(uint32_t *idleTimeMs) {return false;}
#endif
