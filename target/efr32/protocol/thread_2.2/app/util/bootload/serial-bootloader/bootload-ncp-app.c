...
static void printUsage(char *name)
{
  ...
  fprintf(stderr, "  <begin-offset>   required - offset within image to begin, 0 to 0xFFFFFFFF\n");
  fprintf(stderr, "  <length>         required - number of bytes to send, 0 to 0xFFFFFFFF where 0xFFFFFFFF is everything from offset to end of file\n");
...
int main(MAIN_FUNCTION_PARAMETERS)
{
  ...
  errno = 0; /* To distinguish success/failure after call to strtoul */
