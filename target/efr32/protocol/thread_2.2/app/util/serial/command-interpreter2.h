...
/** @brief Parses an IPv6 address in a CLI command.
 *
 * @param index index of the IPv6 address to parse
...
/** @brief Parses an IPv6 prefix in a CLI command.
 *
 * @param index index of the IPv6 prefix to parse
 * @param dst the ::EmberIpv6Address where the address will be written
