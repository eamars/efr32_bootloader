...
// In RTOS builds we need to re-map the binary management send functions
// so that we can have different implementations on either side of things
#if defined(RTOS) && !defined(IP_MODEM_LIBRARY)
  #define emFormatBinaryManagementCommand emFormatBinaryManagementCommandHost
  #define emSendBinaryManagementCommand emSendBinaryManagementCommandHost
  #define emReallySendManagementCommand emReallySendManagementCommandHost
