...
uint8_t readTxControl(void)   { return txControl;   };
uint8_t readRxControl(void)   { return rxControl;   };
uint8_t readAckRx(void)       { return ackRx;       };
uint8_t readAckTx(void)       { return ackTx;       };
uint8_t readFrmTx(void)       { return frmTx;       };
uint8_t readFrmReTx(void)     { return frmReTx;     };
uint8_t readFrmRx(void)       { return frmRx;       };
uint8_t readAshTimeouts(void) { return ashTimeouts; };
