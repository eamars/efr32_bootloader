...
/**
 * Initialize BGAPI class util. This initializer function must be called if any command
 * from this class is going to be used.
 */
void gecko_bgapi_class_util_init();
 ...
 * first call gecko_stack_init() to initialize stack, and then call individual BGAPI class initializer.
 *
 * @param config if set as NULL uses default values for all configuration parameters
 */
