...
# configure compiler
CMAKE_FORCE_C_COMPILER (${TOOLCHAIN_DIR}${TARGET_TRIPLET}gcc${TOOLCHAIN_EXT} GNU)
CMAKE_FORCE_CXX_COMPILER (${TOOLCHAIN_DIR}${TARGET_TRIPLET}g++${TOOLCHAIN_EXT} GNU)
SET(CMAKE_ASM_COMPILER ${TOOLCHAIN_DIR}${TARGET_TRIPLET}gcc${TOOLCHAIN_EXT})

SET (CMAKE_AR ${TOOLCHAIN_DIR}${TARGET_TRIPLET}ar${TOOLCHAIN_EXT})
SET (CMAKE_RANLIB ${TOOLCHAIN_DIR}${TARGET_TRIPLET}ranlib${TOOLCHAIN_EXT})
...
SET(CMAKE_LINKER ${TOOLCHAIN_DIR}${TARGET_TRIPLET}gcc${TOOLCHAIN_EXT})
SET(CMAKE_DEBUGER ${TOOLCHAIN_DIR}${TARGET_TRIPLET}gdb{TOOLCHAIN_EXT})
...
SET(CMAKE_C_FLAGS_DEBUG "-O0 -std=gnu11 -DDEBUG")
SET(CMAKE_CXX_FLAGS_DEBUG "-O0 -std=c++14 -DDEBUG")
