...
#define BTL_SERIAL_APP_PORT BSP_VCOM_USART
#define BTL_SERIAL_APP_BAUD_RATE 115200
#define BTL_SERIAL_APP_TX_PORT BSP_VCOM_TX_PORT
#define BTL_SERIAL_APP_TX_PIN BSP_VCOM_TX_PIN
#define BTL_SERIAL_APP_TX_LOC BSP_VCOM_TX_LOC
#define BTL_SERIAL_APP_RX_PORT BSP_VCOM_RX_PORT
#define BTL_SERIAL_APP_RX_PIN BSP_VCOM_RX_PIN
#define BTL_SERIAL_APP_RX_LOC BSP_VCOM_RX_LOC
#define BTL_LED0_PORT BSP_LED0_PORT
#define BTL_LED0_PIN BSP_LED0_PIN
